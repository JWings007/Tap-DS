...
import { SparklesIcon, CodeBracketIcon, ServerIcon, PresentationChartBarIcon, ChartPieIcon, RocketLaunchIcon, CloudIcon, TrophyIcon, UserGroupIcon } from "@heroicons/react/24/outline";
        ...
        <div className="py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                <div className="text-center mb-16">
                    <h1 className="text-4xl font-semibold pb-4">Learning <span className="text-[#2091d0]">Journey</span></h1>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Your roadmap to becoming a proficient data scientist - carefully structured to build your skills step by step
                    </p>
                </div>
                ...
                <div className="relative">
                    ...
                    {journeySteps.map((step, index) => (
                        ...
                        >
                            {/* Content */}
                            <div className={`w-full md:w-5/12 mb-6 md:mb-0 journey-card ${

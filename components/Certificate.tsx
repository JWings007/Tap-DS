...
function Certificate() {
  return (
    <div className="py-16 px-32">
      ...
      <p className="text-gray-500 tracking-wide text-base pb-14 w-1/2 text-center mx-auto">
      ...
      <div className="grid grid-cols-2 gap-8 content-center justify-items-center">
